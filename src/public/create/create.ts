let email = <HTMLInputElement>document.querySelector(".input")
let password = <HTMLInputElement>document.querySelector(".input2")
let username = <HTMLInputElement>document.querySelector(".input3")
